...
#define STARTADDR ((uint32_t)0x0800A800)         // адрес, с которого будет начинаться запись во флеш (с начала 126-ой страницы F103)
#define ENDMEMORY ((uint32_t)0x0800F800)         // последняя ячейка флеша (F302)
#define PAGES 9                                 // количество страниц для очистки
